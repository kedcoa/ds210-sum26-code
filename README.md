# DS 210 Summer 2026 - Code Repository

This repo contains the code used during [DS 210 Summer 2026](https://rust4ds.github.io/ds210-sum26/) lectures and discussion sections.
...
Lectures and discussion sections that do not introduce new code examples or contain coding activities will have an empty
...
Finally, if a sub directory starts with `q_<n>_`, it represents code given to students as part of a question or exercise, with its answer later published in
a corresponding sub directory starting with `a_<n>_`.
